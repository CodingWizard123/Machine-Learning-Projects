...
class FullyConnected(Layer):
    ...
    def _init_parameters(self, X_shape: Tuple[int, int]) -> None:
        ...
        #self.cache: OrderedDict = ({"W": W, "b": b})  # cache for backprop
    ...
    def backward(self, dLdY: np.ndarray) -> np.ndarray:
        ...
        dLdb = np.matmul(dLdZ.T, np.ones((batchSize, 1))).reshape(self.n_out,)
        ...
        #self.gradients["b"] = dLdb # Ensure `dLdb` has the shape (1, n_out))
